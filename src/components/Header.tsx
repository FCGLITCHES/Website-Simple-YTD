        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center space-x-2 sm:space-x-3">
            ...
            <div className="hidden sm:block">
              <h1 className="text-lg sm:text-xl font-bold text-charcoal-900 dark:text-white transition-colors duration-200">Simply YTD</h1>
              <p className="text-xs text-dark-500 dark:text-gray-400 transition-colors duration-200">Free Video Downloader</p>
            </div>
            <div className="sm:hidden">
              <h1 className="text-base font-bold text-charcoal-900 dark:text-white transition-colors duration-200">Simply YTD</h1>
            </div>
          </div>
          ...
          <div className="md:hidden flex items-center space-x-2">
            ...
            <a 
              href="https://github.com/FCGLITCHES/Website-Simple-YTD/releases/download/v1.0.0/SimpleYTDownloaderSetup.exe"
              className="bg-primary-500 hover:bg-primary-600 text-white px-3 py-2 rounded-lg font-semibold flex items-center space-x-1 sm:space-x-2 transition-all duration-200"
            >
